...
#### f182011 Local Human Lights Product
...
pct <- raster(paste0("data/downloaded/nightlight/pct/F182011.v4c.avg_lights_x_pct.tif"))
...
writeRaster(Local_Human_Lights_version_1, "data/final_products/Local_Human_Lights_f182011.tif", format="GTiff", overwrite=TRUE)
